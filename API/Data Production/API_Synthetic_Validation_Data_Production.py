...
cycleTimes = [1800,2400,3000,3600,4200,4800]
...
def AAPIPostManage(time, timeSta, timeTrans, acycle):
	...
	for t in cycleTimes:
		...
		if time == t:
			...
			for detectorId in DETECTOR_IDS:
				...
				aggregatedArrayMeasurements(time,currentReplicID ,detectorId ,aggList, IDAutonomous_Inter)
	...
	if time == 4800:
		...
		writeCSVfileAllData(aggList,"AllAggregated_True_Data_Validation")
		writeCSVfileAllData(aggListNoDist,"AllAggregated_NoDistinction_True_Data_Validation")
